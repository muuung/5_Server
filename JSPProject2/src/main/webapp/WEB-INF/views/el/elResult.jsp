...
<body>
    ...
    메세지 : <%= message %><br>
    person의 name : <%= p.getName() %><br>
    person의 age : <%= p.getAge() %><br>
    person의 address : <%= p.getAddress() %><br>
    pserson.toString() : <%= p.toString() %><br><br>
    
    <hr>
    
    <h3>EL에서 null과 '비어있다'에 대한 처리 방법</h3>
    
    <h4 style="color:red">EL은 null과 비어있다를 구분할 수 없음</h4>
    ...
    <pre>
    	...
    	-> EL은 List에 존재하는 요소를 얻어올 때 배열처럼 [index번호]를 입력해서 얻어옴
    </pre>
</body>
</html>