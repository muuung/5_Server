...
<body>
    <!-- 
        ...
        태그의 이름만 봤을 때 나눈다는 것 이외의 의미를 파악할 수 없음
     ...
     <main>
        <header>
            <section><img src="/project1/resources/images/logo.jpg" id="home-logo"></section>
            <section>
